...
export default ({ type, data, isGrid, parentType, index }: CardProps) => {
    ...
    const onNavigation = (data) => {
        ...
        if (allData[type] != undefined) {
            navigation.navigate('CardListingScreen', { type: type, source: source, items: data.children, title: data.nameArabic, id: data.id, parentType: parentType })
