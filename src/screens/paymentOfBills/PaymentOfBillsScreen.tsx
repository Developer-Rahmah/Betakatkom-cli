...
import PaymentOfBillsCard from '../home/components/PaymentOfBillsCard';
  ...
  return (
    <>
      ...
      <ImageBackground resizeMode='repeat' style={General.flex} source={Background}>
        <Balance />
        <AnimatedFlatList
          contentContainerStyle={{ width: SCREEN_WIDTH, alignItems: 'center', justifyContent: 'center', paddingTop: 20 }}
          ...
          renderItem={({ item, index }) => {
            return (
              <View style={{ width: '100%', justifyContent: 'center', alignItems: 'center', }}>
                {/* <Card parentType={route.params.parentType} type={index} data={item} index={index} isGrid={false} /> */}
                <PaymentOfBillsCard parentType={route.params.parentType} type={index} data={item} index={index} isGrid={false} />
...
export default PaymentOfBillsScreen;
